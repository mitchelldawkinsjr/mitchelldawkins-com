...
The pipeline is available as open source: **[issue-bench](https://github.com/mitchelldawkinsjr/issue-bench)** — use the template or run `npx issue-bench init` to add it to your repo.

<LiveSiteButton href="https://github.com/mitchelldawkinsjr/issue-bench">Get issue-bench</LiveSiteButton>
...
2. I add **`needs-spec`** and go back to my work — the spec comment arrives before I finish reading a few reddit posts
