...
description: "A film-grading pipeline and coach hub for weekly and season-long receiver evaluations — year-two v2 adds drop-a-CSV ingest, a two-season landing page, and a player-facing rubric."
date: "2026-08-29"
status: "Active"
featured: true
priority: 9
...
links:
  ...
  - title: "Live Hub"
    url: "https://ghfb.360web.cloud/film/"
  - title: "Technical Deep Dive"
    url: "/blog/gh-film-review-pipeline-deep-dive"
  - title: "Blog: Film Hub v2"
    url: "/blog/gh-film-hub-v2-year-two"
why: "Coaches should not spend Sundays hand-building film reports. Automate CSV film logs into weekly and season evaluations coaches actually use."
streamFocus: "Year-two hub UX, sheet-to-pages ingest, and keeping the rubric in front of players."
lessons:
  - "Meet coaches where the data already is — CSV film logs."
  - "Static sites + Actions beat bespoke hosting for seasonal sports tools."
  - "A rubric players cannot read on the hub is still a private script."
roadmap:
  - "Keep 2026-2027 weeks publishing through process-week"
  - "Add sheet codes to LEGEND_POINTS the same day they appear on film"
relatedPosts:
  - "gh-film-hub-v2-year-two"
  - "gh-film-review-pipeline-deep-dive"
  - "hosting-gh-film-review-free-github-pages"
---
...
**Status: Active** — Year two (2026–2027) is live on the Film Review Hub. Week files ingest from a published sheet, git, or the hub upload helper; the same grading engine publishes dashboards, PDFs, and a two-season landing page. See [GH Film Hub v2](/blog/gh-film-hub-v2-year-two).
...
- Extra Point Conversion: +2 points
...
- Lack of Focus: -0.5 points
- Bad Body Language: -0.5 points
...
Shipped in v2 (2026–2027):

- **CSV ingest Action** — published sheet, git push, or hub upload helper
- **Two-season hub** with Top 5 WRs and year-one archive
- **How to score well** on every season page
- **Year-two codes** — Extra Point, Lack of Focus, Bad Body Language

Still on the board when coaches ask:

- **Video Integration** linking reports to specific game footage timestamps
- **Sideline data entry** without leaving the film sheet workflow
