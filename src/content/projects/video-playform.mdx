...
links:
  - title: "Development Blog"
    url: "/blog/introducing-video-processing-platform"
...
The MVP is targeting late-2026 for initial beta access with core functionality, with continual feature expansion planned throughout the year.
